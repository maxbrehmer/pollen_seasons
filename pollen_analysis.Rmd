...
To proceed fitting the model, we attempt to find the maximum likelihood estimate (MLE) of $\beta(\tau)$ and $\sigma^2(\tau)$ by optimizing the maximization problem
$$
\arg \max_{(\beta, \sigma^2) \in \mathbb{R^2}} \, l_{w}(\beta(\tau), \sigma^2(\tau) \mid Y(\tau),X)
$$
