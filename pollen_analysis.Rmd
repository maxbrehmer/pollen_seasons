...
#eq_joined_1_desc <- eq_joined_1 %>% arrange(desc("Coefficient (Q = 1%)"))
...
#eq_joined_50_desc <- eq_joined_50 %>% arrange(desc("Coefficient (Q = 50%)"))
...
#eq_joined_95_desc <- eq_joined_95 %>% arrange(desc("Coefficient (Q = 95%)"))
  
#kable(head(eq_joined_1, 6), caption = "Most affected 1% (EQ)")
eq_joined_1 %>% head(6) %>% kable(caption = "Least affected 1% (EQ)")
eq_joined_1 %>% arrange(desc("Coefficient (Q = 1%)")) %>% head(6) %>% kable(caption = "Least affected 1% (EQ)")

#kable(head(eq_joined_50, 6), caption = "Most affected 50% (EQ)")
#kable(head(eq_joined_50_desc, 6), caption = "Least affected 50% (EQ)")
eq_joined_50 %>% head(6) %>% kable(caption = "Least affected 50% (EQ)")
eq_joined_50 %>% arrange(desc("Coefficient (Q = 50%)")) %>% head(6) %>% kable(caption = "Least affected 50% (EQ)")

#kable(head(eq_joined_95, 6), caption = "Most affected 95% (EQ)")
#kable(head(eq_joined_95_desc, 6), caption = "Least affected 95% (EQ)")
eq_joined_95 %>% head(6) %>% kable(caption = "Least affected 95% (EQ)")
eq_joined_95 %>% arrange(desc("Coefficient (Q = 95%)")) %>% head(6) %>% kable(caption = "Least affected 95% (EQ)")
```
