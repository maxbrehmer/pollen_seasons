...
# EQ models
head(joined_eq_1, 4)
head(joined_eq_1 %>% map_df(rev), 4)

head(joined_eq_50, 4)
head(joined_eq_50 %>% map_df(rev), 4)

head(joined_eq_95, 4)
head(joined_eq_95 %>% map_df(rev), 4)

# QR models
head(joined_qr_1, 4)
head(joined_qr_1 %>% map_df(rev), 4)

head(joined_qr_50, 4)
head(joined_qr_50 %>% map_df(rev), 4)

head(joined_qr_95, 4)
head(joined_qr_95 %>% map_df(rev), 4)
```
