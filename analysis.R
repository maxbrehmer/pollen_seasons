...
data_structure <- data.frame("Variable" = c("Station", "Species", "Date", "Count", "Factor", "Latitude"), 
                             "Type" = c("Categorical", "Categorical", "Continous", "Continous", "Continous", "Continous"), 
...
colnames(stations) <- c("Station", "Latitude", "Pollen genus (since the year)")
